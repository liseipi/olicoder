...
import com.olicoder.plugin.model.ProviderType
...
/**
 * Settings -> Tools -> Oli Coder 设置页
 * 左边是配置档列表（可增删），右边是当前选中档案的编辑表单。
 */
class OliCoderSettingsConfigurable : Configurable {

    private val state = OliCoderSettingsState.getInstance()
    ...
    override fun getDisplayName(): String = "Oli Coder"
