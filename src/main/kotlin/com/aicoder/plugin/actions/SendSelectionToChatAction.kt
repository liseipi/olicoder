package com.aicoder.plugin.actions

import com.aicoder.plugin.toolwindow.ChatToolWindowFactory
...
class SendSelectionToChatAction : AnAction("发送选中代码到 AI 对话") {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val toolWindow = ToolWindowManager.getInstance(project).getToolWindow("AI Coder")
        toolWindow?.show {
